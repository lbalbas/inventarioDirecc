		...
		echo'
				<html lang="en">
					...
					<div class="w-full h-full flex flex-col justify-end items-center">
					  ...
					  <div class="font-rubik flex flex-col pt-24 justify-evenly pb-12 gap-3 w-5/12 px-16 bg-gray-100">
						  <div>					  
						  ...
						  <p class="text-gray-400">Bienvenid@ al Sistema de Control y Seguimiento de Bienes de la Oficina de Administración y Gestión de Bienes</p>
						      ...
						      <input class="w-full px-6 py-3 cursor-pointer hover:bg-blue-300 hover:text-blue-600 bg-blue-600 text-white" type="submit">
						    </form>
